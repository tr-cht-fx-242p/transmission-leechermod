	...
	****/
	...
	getStateString: function() {
		switch(this.getStatus()) {
			case Torrent._StatusStopped:      return this.isFinished() ? 'Seeding complete' : 'Manually paused';
	...
	****/
	...
	testState: function(state)
	{
		...
		switch(state)
		{
			...
			case Prefs._FilterPausedOnly:
				return this.isStopped() && !this.isFinished();
			case Prefs._FilterPausedFinished:
				return this.isStopped();
			case Prefs._FilterFinishedOnly:
