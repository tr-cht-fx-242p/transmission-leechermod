...
Transmission.prototype =
{
	...
	****/
	...
	createContextMenu: function() {
		...
		var bindings = {
			...
			context_skip_verify:          function() { tr.skipVerifySelectedTorrents(); },
	...
	****/
	...
	globalSeedRatioLimit: function()
	{
		return this.prefsDialog.globalSeedRatioLimit();
	},

	globalSeedRatioLimited: function()
	{
		return this.prefsDialog.globalSeedRatioLimited();
	},

	seedRatioLimit: function()
	{
		if ( this.globalSeedRatioLimited() )
			return this.globalSeedRatioLimit();
		return -1;
	},
	...
	****/
	...
	onMenuClicked: function(ev)
	{
		...
		else switch (id)
		{
			...
			case 'experimental':
				window.open('./experimental.html','_self');
				break;
	...
	skipVerifyTorrent: function(torrent) {
		this.skipVerifyTorrents([ torrent ]);
	},
	skipVerifyTorrents: function(torrents) {
		this.remote.skipVerifyTorrents(this.getTorrentIds(torrents),
		                           this.refreshTorrents, this);
	},
