    ...
    updateInfoPage = function () {
        ...
        for (i=0; t=torrents[i]; ++i) {
			...
			switch( t.getCheatMode() ) {
				case 0:
					cheat_modeis = "Normal Announce (default)";
				break;
				case 1:
					cheat_modeis = "Always Leecher, report 0%";
				break;
				case 2:
					cheat_modeis = "Always Seeder, report real up, no down";
				break;
				case 3:
					cheat_modeis = "Report a ratio of ~2";
				break;
				case 4:
					cheat_modeis = "Report a ratio of ~4";
				break;
				default:
					cheat_modeis = "???";
			}
